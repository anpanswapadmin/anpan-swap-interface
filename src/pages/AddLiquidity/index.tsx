...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@anpanswap-libs/sdk'
import { Button, CardBody, AddIcon, Text as UIKitText } from '@anpanswap/uikit'
      ...
      <AutoColumn gap="20px">
        ...
        <Row>
          <UIKitText fontSize="24px">
            {t('%symbolA%/%symbolB% Pool Tokens', {symbolA: currencies[Field.CURRENCY_A]?.symbol ?? '', symbolB: currencies[Field.CURRENCY_B]?.symbol ?? '',})}
          </UIKitText>
        </Row>
