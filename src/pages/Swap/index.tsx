...
import HoneyWarningModal from 'components/HoneyWarningModal'
...
const Swap = () => {
  ...
  const handleOutputSelect = useCallback(
    (outputCurrency) => {
      ...
      if (outputCurrency.symbol === 'HONEY') {
  ...
  return (
    <>
      ...
      />
      <HoneyWarningModal
        isOpen={transactionWarning.selectedToken === 'HONEY'}
                  ...
                  >
                    {approval === ApprovalState.PENDING ? (
                      <AutoRow gap="6px" justify="center">
                        {t('Enabling')} <Loader stroke="white" />
                      </AutoRow>
                    ) : approvalSubmitted && approval === ApprovalState.APPROVED ? (
                      t('Enabled')
                    ) : (
