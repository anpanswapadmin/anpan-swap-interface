...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@anpanswap-libs/sdk'
import { Button, Flex, Text } from '@anpanswap/uikit'
    ...
    return (
      <>
        <RowBetween>
          ...
          LP {t('%assetA%/%assetB% Burned', { assetA: currencyA?.symbol ?? '', assetB: currencyB?.symbol ?? '' })}
          <RowFixed>
