...
import { JSBI, Pair, Percent } from '@anpanswap-libs/sdk'
import { Button, Card as UIKitCard, CardBody, Text } from '@anpanswap/uikit'
    ...
    <HoverCard>
      <AutoColumn gap="12px">
        <FixedHeightRow onClick={() => setShowMore(!showMore)} style={{ cursor: 'pointer' }}>
          <RowFixed>
            <DoubleCurrencyLogo currency0={currency0} currency1={currency1} margin size={20} />
            <Text>{!currency0 || !currency1 ? <Dots>{t('Loading')}</Dots> : `${currency0.symbol}/${currency1.symbol}`}</Text>
          </RowFixed>
          <RowFixed>
            {showMore ? (
        ...
        {showMore && (
          <AutoColumn gap="8px">
            <FixedHeightRow>
              <RowFixed>
                <Text> {currency0.symbol} {t('Pooled:')}</Text>
              </RowFixed>
              {token0Deposited ? (
                <RowFixed>
            ...
            <FixedHeightRow>
              <RowFixed>
                <Text> {currency1.symbol} {t('Pooled:')}</Text>
              </RowFixed>
              {token1Deposited ? (
                <RowFixed>
